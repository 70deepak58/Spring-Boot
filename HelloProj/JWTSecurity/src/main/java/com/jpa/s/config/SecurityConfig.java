...
//		return new InMemoryUserDetailsManager(admin,user);
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		return http.cors().and().csrf().disable()
		    ...
		    .requestMatchers("/pro/first","/pro/addUser","/pro/authenticate","/pro/getall","/pro/delete","/pro/otp/generate","/pro/otp/authenticate","/pro/otp/authenticate","/pro/a","/pro/deleteAuth/**").permitAll()
		    .and()
